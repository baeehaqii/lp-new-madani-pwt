...
export default function Gallery() {
  ...
  const galleryImages = [
    {
      src: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762291406/01_A_kaw08d.avif",
    ...
    {
      src: "https://www.instagram.com/reel/C8EqC7nvrgL/",
      alt: "Instagram Reel 1",
      type: "video",
      thumbnail: "https://res.cloudinary.com/dqobwse9q/image/upload/v1762291406/01_A_kaw08d.avif",
    },
    {
      src: "https://www.instagram.com/reel/C8EqC7nvrgL/",
  ...
  return (
    <section id="gallery" className="section">
      <div className="container">
        <h2 className="section-title">Gallery Sapphire Madani Purwokerto</h2>
        <p className="section-subtitle">
          Temukan keindahan dan kenyamanan rumah impian Anda di Sapphire Madani Purwokerto . Setiap sudut dirancang dengan
