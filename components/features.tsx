import { ShieldCheck, Trees, CarFront, LockKeyhole } from "lucide-react"
  ...
  return (
    <section id="fasilitas" className="features-section">
      <div className="container">
        <h2 className="section-title">Ketenangan Alam, Dekat dengan Segala Kemudahan</h2>
        <p className="section-subtitle">
          Kawasan Asri yang Tetap Terkoneksi dengan Pusat Aktivitas Kota
        </p>
