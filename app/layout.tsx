...
export const metadata: Metadata = {
  title: "Sapphire Madani Purwokerto",
  description: "Temukan properti impian Anda bersama Sapphire Madani Purwokerto",
  icons: {
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-KLTDQPG5');`
        }} />
      ...
      <body style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KLTDQPG5"
            height="0"
            width="0"
